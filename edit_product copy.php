...
<body>
    ...
    <form action="save_product.php" method="POST" enctype="multipart/form-data">
        ...
        <select name="branding_option" id="branding_option" required>
            ...
            <option value="digital-uv-printing"
                <?php echo ($product['branding_options'] == 'digital-uv-printing') ? 'selected' : ''; ?>>Digital UV
                Printing</option>
            <option value="blind-embossing"
                <?php echo ($product['branding_options'] == 'blind-embossing') ? 'selected' : ''; ?>>Blind Embossing
            </option>
            <option value="golden-embossing"
                <?php echo ($product['branding_options'] == 'golden-embossing') ? 'selected' : ''; ?>>Golden Embossing
            </option>
            <option value="silver-embossing"
                <?php echo ($product['branding_options'] == 'silver-embossing') ? 'selected' : ''; ?>>Silver Embossing
            </option>
            <option value="logo-effect-digital-uv"
                <?php echo ($product['branding_options'] == 'logo-effect-digital-uv') ? 'selected' : ''; ?>>LOGO EFFECT
                - Digital UV Printing</option>
            <option value="logo-effect-laser-engraving"
                <?php echo ($product['branding_options'] == 'logo-effect-laser-engraving') ? 'selected' : ''; ?>>LOGO
                EFFECT - LASER ENGRAVING</option>
        </select><br><br>
        ...
        <div id="product_image">
            ...
            <img id="logo_preview"
                ...
                alt="Logo Preview" style="width: 120px; height: auto;">
        </div>
    ...
    $(document).ready(function() {
        ...
        $logoPreview.draggable({
            ...
            stop: function(event, ui) {
                ...
                $('#logo_position').val(JSON.stringify({
                    top: topPercent,
                    left: leftPercent
                }));
            }
